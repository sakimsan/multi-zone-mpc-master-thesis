...
class SimulationConfig(BaseModel):
    ...
    @field_validator("save_results")
    @classmethod
    def deprecated_save_results(cls, save_results):
        if save_results is None:
            return True
        if not save_results:
            logger.warning("Save-results option was removed, they will always be saved.")
        return True
...
def start_dymola(
    ...
    # dym_api.dymola.experimentSetupOutput(
    #     states=False,
    #     derivatives=False,
    #     inputs=False,
    #     outputs=True,
