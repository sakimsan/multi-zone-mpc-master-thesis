...
class BESMod(SurrogateBuilder):
    ...
    def simulate(self, parameters, log_df):
        ...
        results = result_handling.merge_results(results, _skipped_results)
