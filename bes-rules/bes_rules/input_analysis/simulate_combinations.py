...
from bes_rules.boundary_conditions.building import get_teaser_model_name_with_modifiers
...
def simulate_all_combinations(
    ...
    model_names = [
        f"{model_name}{input_config.get_modelica_modifier(with_custom_modifier=False)}"
