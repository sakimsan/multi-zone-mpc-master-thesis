...
class TEWI(BaseObjective):
    ...
    e_pv: StochasticParameter = StochasticParameter(value=50)  # TODO: Does this make sense? Negative?
    ...
    def calc(self, df: pd.DataFrame, input_config: "InputConfig" = None):
        ...
        emissions_pv = self.e_pv * self.get_values(
        ...
        emissions_tot = (emissions_el + emissions_ref_ann + emissions_pv +
