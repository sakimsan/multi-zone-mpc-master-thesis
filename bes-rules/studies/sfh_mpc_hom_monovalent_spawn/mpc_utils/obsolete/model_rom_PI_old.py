...
class MPC(CasadiModel):
    ...
    def setup_system(self):
        ...
        #   DGL
        self.yValSet.ode = (1 / tau_valve) * (ca.fmin(ca.fmax(pi_ctrl_output, 0), 1) - self.yValSet)   # consider constraints of pi_ctrl [0,1]. If pi_ctrl_output < 0, yValSet --> 0. If pi_ctrl_output > 1, yValSet --> 1. Otherwise yValSet --> pi_ctrl_output
        ...
        self.constraints = [
            ...
            # electric power
            (0, P_el_feed + self.P_el_feed_into_grid - self.P_el_feed_from_grid, 0),
        ...
        objective = sum(
            [
                C_el,
                C_comf,
                100 * self.TTraSup_slack ** 2,
                100 * self.THeaPumSup_slack ** 2,
                100 * self.QHeaPum_flow_slack ** 2,
                100 * self.PEleHeaPum_slack ** 2,
            ]
        )
