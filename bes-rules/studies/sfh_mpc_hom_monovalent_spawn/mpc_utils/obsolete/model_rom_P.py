...
class MPC(CasadiModel):
    ...
    def setup_system(self):
        ...
        valve_ctrl_k = 2 * bes_parameters["hydraulic.control.valCtrl.PI[1].k"]
        valve_ctrl_Ti = bes_parameters["hydraulic.control.valCtrl.PI[1].Ti"]
        error = self.TSetOneZone - self.T_Air
        #   try simple P-ctrl
        p_ctrl_output = valve_ctrl_k * error
        valve_output = ca.fmin(ca.fmax(p_ctrl_output, 0), 1)  # set limits [0,1]
