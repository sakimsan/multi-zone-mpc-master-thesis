...
class MPC(CasadiModel):
    ...
    def dump_ode_equations_txt(self, filename1="ode_equations_test.txt", filename2="alg_equations_test.txt"):
        """
        Exportiere alle .ode-Zuweisungen aus self._states als Klartextdatei.
        Funktioniert immer – auch ohne graph() oder generate().
        """
        odes = []
    ...
    def dump_bounded_constraints_txt(self, filename="bounded_constraints_test.txt"):
        import os
