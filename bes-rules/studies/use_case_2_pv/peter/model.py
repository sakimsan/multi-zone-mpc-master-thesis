...
class MPCModelConfig(CasadiModelConfig):
    ...
    parameters: List[CasadiParameter] = [
        ...
        # costs
        CasadiParameter(name="c_el_feed_from_grid", value=36.06, unit="ct/kWh",
                        description="Power Price"),
        CasadiParameter(name="c_el_feed_into_grid", value=-8.2, unit="ct/kWh",
                        description="Power Price"),
    ]
...
class MPC(CasadiModel):
    ...
    def setup_system(self):
        ...
        # buffer storage
        mHeaPum_flow = mTra_flow
        component_models.storage_in_serial_connection(
            casadi_model=self, bes_parameters=bes_parameters, mSto_flow=mHeaPum_flow
        )
        ...
        # Objective function
        C_el_feed_from_grid = self.c_el_feed_from_grid / 3600 * self.P_el_feed_from_grid / 1000
        C_el_feed_into_grid = self.c_el_feed_into_grid / 3600 * self.P_el_feed_into_grid / 1000
        C_el = C_el_feed_from_grid + C_el_feed_into_grid  # ct/kWh * 1h/3600s * W / 1000
