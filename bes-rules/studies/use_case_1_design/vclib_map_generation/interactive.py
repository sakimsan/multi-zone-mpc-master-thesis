...
def create_app(filepath: pathlib.Path):
...
if __name__ == '__main__':
    ...
    #APP = create_app(pathlib.Path(r"D:\02_Paper\01_vclibpy\Results_5d\EN_MEN412_EN412\OptiHorst_R410A.sdf"))
    APP = create_app(pathlib.Path(r"D:\06_Results\vitocal\map_ihx_high_dT_clean\ParameterCombination_0\map_with_frosting.sdf"))
